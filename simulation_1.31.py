...
plt.plot (tank_size_1, centralized_pumping_energy_cum_1, 'm-')
plt.title('Cumulative Centralized Pumping Energy')
plt.xlabel('Tank Size in m3')
plt.ylabel('Pumping Energy Required in kWh')
plt.show ()

plt.plot (tank_size_1, avoided_pumping_energy_cum_1, 'g-')
plt.title('Cumulative Avoided Pumping + Treatment Energy')
plt.xlabel('Tank Size in m3')
plt.ylabel('Avoided Energy in MJ')
plt.show ()

plt.plot (tank_size_1, outflow_cum_1, 'k-')
plt.title('Cumulative Outflow')
plt.xlabel('Tank Size in m3')
plt.ylabel('Water Savings in m3')
plt.show ()

plt.plot (tank_size_1, pumping_energy_cum_1 , 'c-')
plt.title('Cumulative Pumping Energy for Household')
plt.xlabel('Tank Size in m3')
plt.ylabel('kWh')
plt.show ()