...
energy_conversion_factor= 10.9 #MJ/kWh
treatment_energy_intensity = 1.3 #MJ/m3
...
for tank_size in np.linspace(0, 30, 20):
    ...
    centralized_pumping_energy_cum = 0
    ...
    for (precipitation, date) in zip(precipitations, dates):
        ...
        centralized_pumping_energy_cum += centralized_pumping_energy
        avoided_pumping_energy = centralized_pumping_energy * energy_conversion_factor + treatment_energy
        avoided_pumping_energy_cum += avoided_pumping_energy
        ...
        pumping_energy_cum += pumping_energy
        pumping_energy_cum_1.append(pumping_energy_cost_cum)
        operation_energy = pumping_energy_cum * energy_conversion_factor + total_maint_energy #MJ
        net_embodied_energy_saving = avoided_pumping_energy_cum - construction_energy - operation_energy
    ...
    treatment_energy_1.append(treatment_energy)  
    centralized_pumping_energy_1.append(centralized_pumping_energy)
    avoided_pumping_energy_1.append(avoided_pumping_energy)
    treatment_energy_cum_1.append(treatment_energy_cum)
    centralized_pumping_energy_cum_1.append(centralized_pumping_energy_cum)
    avoided_pumping_energy_cum_1.append(avoided_pumping_energy_cum)
    operation_energy_1.append(operation_energy)
    net_embodied_energy_saving_1.append(net_embodied_energy_saving)
